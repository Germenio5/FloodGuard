...
$floodMetrics = [
    ...
    ['label' => 'Evacuated Residents', 'value' => '54'],
    ['label' => 'Road Closures', 'value' => '7'],
    ['label' => 'Expected Rainfall', 'value' => '5m'],
    ['label' => 'Flooding Severity', 'value' => 'Critical', 'is_critical' => true]
];
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="content-grid">
                <section class="metrics-section">
                    ...
                    <div class="description">
                        <p>Our flood maps provide a clear view of areas that may be affected by flooding, including rivers, coastal zones, and surface water. They are a public resource designed to help residents and authorities make informed decisions and stay safe during flood events.</p>
                    </div>
                </section>
                ...
                <section class="map-section">
                    ...
                    <a href="<?= BASE_URL ?>view/map.php" class="view-map-btn">View Map</a>
                </section>
            </div>
        </div>
    </main>
